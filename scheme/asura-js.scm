...
(define GOAL_DIST_CALIB_POLEa jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_POLEa$)
(define GOAL_DIST_CALIB_POLEb jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_POLEb$)
(define GOAL_DIST_CALIB_POLEc jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_POLEc$)
(define GOAL_DIST_CALIB_HEIGHTa jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_HEIGHTa$)
(define GOAL_DIST_CALIB_HEIGHTb jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_HEIGHTb$)
(define GOAL_DIST_CALIB_HEIGHTc jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_HEIGHTc$)
(define GOAL_DIST_CALIB_WIDTHa jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_WIDTHa$)
(define GOAL_DIST_CALIB_WIDTHb jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_WIDTHb$)
(define GOAL_DIST_CALIB_WIDTHc jp.ac.fit.asura.nao.vision.VisualParam$Float.GOAL_DIST_CALIB_WIDTHc$)
