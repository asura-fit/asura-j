...
(set-circleturn-samples 28)
(set-turn-config 0.035f 0.015f 0.025f 0.25f 0.22f 3.3f)
(set-walk-config 0.02f 0.016f 0.02f 0.4f 0.216f 0.0f)
(set-walk-trapezoidConfig 6.0f -6.0f)



;(set-walk-jointpower "RHipPitch" 0.84f)
;(set-walk-jointpower "LHipPitch" 0.84f)
;(set-walk-jointpower "RHipYawPitch" 0.65f)
;(set-walk-jointpower "LHipYawPitch" 0.65f)
;(set-walk-jointpower "RHipRoll" 0.82f)
;(set-walk-jointpower "LHipRoll" 0.82f)
;(set-walk-jointpower "RAnkleRoll" 0.8f)
;(set-walk-jointpower "LAnkleRoll" 0.8f)
;(set-walk-jointpower "RKneePitch" 0.6f)
;(set-walk-jointpower "LKneePitch" 0.7f)
...
(set-walk-jointpower "RHipPitch" 0.84f)
(set-walk-jointpower "LHipPitch" 0.84f)
(set-walk-jointpower "RHipYawPitch" 0.75f)
(set-walk-jointpower "LHipYawPitch" 0.75f)
(set-walk-jointpower "RHipRoll" 0.82f)
(set-walk-jointpower "LHipRoll" 0.82f)
(set-walk-jointpower "RAnkleRoll" 0.8f)
(set-walk-jointpower "LAnkleRoll" 0.8f)
