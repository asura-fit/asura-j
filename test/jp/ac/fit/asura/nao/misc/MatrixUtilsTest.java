...
public class MatrixUtilsTest extends TestCase {
	...
	public void testTransform() {
		Vector3f v;
		v = MatrixUtils.transform(new Vector3f(), new AxisAngle4f(), 0.0f,
				new Vector3f());
		assertTrue(new Vector3f().epsilonEquals(v, 0.0001f));

		v = MatrixUtils.transform(new Vector3f(), Nao.rHeadYaw2body, 1.0f,
				Nao.tHeadYaw2body);
	...
	public void testInverseTransform() {
		...
		v = MatrixUtils.inverseTransform(new Vector3f(), Nao.rHeadYaw2body,
				0.0f, Nao.tHeadYaw2body);
		assertTrue(new Vector3f(0, -160, 20).epsilonEquals(v, 0.0001f));

		v = MatrixUtils.transform(new Vector3f(10, 10, 10), Nao.rHeadYaw2body,
				1.0f, Nao.tHeadYaw2body);
		v = MatrixUtils.inverseTransform(v, Nao.rHeadYaw2body, 1.0f,
				Nao.tHeadYaw2body);
